...
const getHeaders = () => {
  ...
  if (storeToken?.startsWith('ey')) return { Authorization: `Bearer ${storeToken}` }
  return {}
}

// ✅ Pas de generiques TypeScript pour eviter l erreur de parsing Vue
...
.notif-header {
  ...
  .nav-link {
    ...
    &:hover  { color: #ffffff !important; border-bottom-color: rgba(255,255,255,0.5) !important; }
    &.active { color: #ffffff !important; border-bottom-color: #ffffff !important; }
  }
}
.notif-item {
  cursor: pointer;
