...
export class ProjectControllerBase {
  ...
  async create(
    ...
    return await this.service.create({
      data: {
        ...
        user: data.user
          ? {
              connect: {id: "0a6ef296-6b69-41e0-bad1-290e937f6b64"},
            }
          : undefined,
      },
      select: {
  ...
  async update(
    ...
    try {
      const array = data.images?.filter((img) => img.id !== undefined)
                            .map((img) => img.id as string) ?? undefined
