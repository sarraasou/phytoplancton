...
export class ImageControllerBase {
  ...
  //     cloudinary.uploader
  //       .upload_stream({ folder: "pfe-phyto-images" }, (error, result) => {
  ...
  //   @common.Body("projectId") projectId: string
  // ): Promise<Image[]> {
